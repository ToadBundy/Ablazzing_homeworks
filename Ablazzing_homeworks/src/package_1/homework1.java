...
public class homework1 {
    public static void main(String[] args) {
        ...
        System.out.println("********************");
        System.out.println("Advanced level task 3(variant 2)");
        for (int i = 0; i< array_num1.length; i++){
            result[i] = array_num1[i];
            result[i+5] = array_num2[i];
            result[i+10] = array_num1[i]*array_num2[i];
        }
        System.out.println(Arrays.toString(result));
        //
        //Ожидаемый результат:
    ...
    public static void mask(String js_text){
